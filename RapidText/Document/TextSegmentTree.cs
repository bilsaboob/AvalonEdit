...
namespace RapidText.Document
{
	...
	public class TextSegmentTree<T> : ICollection<T>, ISegmentTree 
		where T : TextSegment
	{
		...
		public TextSegmentTree(TextDocument textDocument)
		{
		...
		protected void OnDocumentChanged(DocumentChangeEventArgs e)
		{
